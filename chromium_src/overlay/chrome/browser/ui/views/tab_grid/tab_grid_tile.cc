...
TabGridTile::TabGridTile(int tab_index, const std::u16string &title,
                         bool is_active, PressedCallback callback)
    : views::Button(std::move(callback)), tab_index_(tab_index),
...
void TabGridTile::UpdateBorder() {
  SkColor border_color =
      is_active_ ? SkColorSetRGB(26, 115, 232)   // Active: Google Blue
  ...
  SkColor bg_color =
      is_active_ ? SkColorSetRGB(241, 248, 255) : SkColorSetRGB(255, 255, 255);
